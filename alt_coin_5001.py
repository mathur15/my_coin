...
# Part 1 - Building a Blockchain- adding in transactions to the block and 
#mining process
...
class Blockchain:
    ...
    def __init__(self):
        self.chain = []
        self.transactions = [] #before added to the block
    ...
    def create_block(self, proof, previous_hash):
        ...
        self.transactions = [] #update transactions after added to the block
    ...
    def add_nodes(self,new_address):
        #parse address urlparse
        parsed_url = urlparse(new_address)
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {'message': 'The nodes have different chains so the chain was replaced.',
